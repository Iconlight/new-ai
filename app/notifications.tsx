        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <List.Item
              ...
              description="Receive personalized conversation topics"
            ...
            <List.Item
              ...
              description={`Generate ${preferences.daily_conversation_count} topics per day`}
        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <Text variant="bodyMedium" style={styles.infoText}>
              • Daily conversation starters are generated based on your interests
            </Text>
            <Text variant="bodyMedium" style={styles.infoText}>
              • Notifications include current news and trending topics
            </Text>
            <Text variant="bodyMedium" style={styles.infoText}>
              • You can disable notifications anytime in settings
            </Text>
            <Text variant="bodyMedium" style={styles.infoText}>
              • Networking matches will also send notifications when enabled
            </Text>
          </Card.Content>
        </Card>
      </ScrollView>
